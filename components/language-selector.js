...
class LanguageSelector {
    constructor() {
        ...
        this.languages = [
            ...
            { code: 'zh-MY', name: 'Chinesez (Malayzia)', localName: '华文（马来西亚）', link: 'https://chronie-shizutoki.github.io/self-info-zh-my/' },
            { code: 'zh-SG', name: 'Chinesez (Singapur)', localName: '华文（新加坡）', link: 'https://chronie-shizutoki.github.io/self-info-zh-sg/' },
