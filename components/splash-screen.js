...
class PrivacyConsentPopup {
    ...
    handleReject() {
        ...
        <div class="splash-content">
            <h3 class="privacy-title">Oh Noes! U canz not come in!</h3>
            <p class="privacy-text">If yu no agreez to da privehsee roolz, yu canz not see teh site.</p>
            <p class="privacy-text">Sendin yu back to teh front page in 5 secondz...</p>
        </div>
        `;
